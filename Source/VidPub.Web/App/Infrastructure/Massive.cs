...
namespace Massive {
    ...
    public class DynamicModel : DynamicObject {
        ...
        public List<dynamic> ForeignKeys { get; set; }
        public List<dynamic> ManyToManys { get; set; }
        public void AddForeignKey(string tableName, string foreignKey) {
            this.ForeignKeys.Add(new { TableName = tableName, ForeignKey = foreignKey });
        }
        public void AddManyToMany(string joinTable, string foreignTable, string foreignKey) {
            this.ManyToManys.Add(new { JoinTable = joinTable, ForeignTable = foreignTable, ForeignKey = foreignKey });
        }
        /// <summary>
